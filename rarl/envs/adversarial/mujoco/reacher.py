...
class ReacherEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        ...
        ## Adversarial setup
        self._adv_f_bname = "body0"  # Byte String name of body on which the adversary force will be applied
        # bnames = self.model.body_names
        bnames = ("world", "body0", "body1", "fingertip", "target")
    ...
    def _adv_to_xfrc(self, adv_act):
        ...
        new_xfrc[self._adv_bindex] = np.array(
            [adv_act[0], adv_act[1], 0.0, 0.0, 0.0, 0.0]
        )
