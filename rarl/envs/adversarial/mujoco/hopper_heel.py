...
class HopperHeelEnv(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        mujoco_env.MujocoEnv.__init__(self, "hopper.xml", 4)
        utils.EzPickle.__init__(self)
        ## Adversarial setup
        self._adv_f_bname = "foot"  # Byte String name of body on which the adversary force will be applied
        bnames = ("world", "torso", "thigh", "leg", "foot")
