...
def make_biased_sst(
    ...
    if (
        ...
        and os.path.isfile(os.path.join(save_dir, "train.tsv"))
        and not overwrite
    ):
        return (
            [
    ...
    # Return
    return (
        [to_biased_example(ex, bias_string) for ex in data["train"]],
        [to_biased_example(ex, bias_string) for ex in data["dev"]],
        [to_biased_example(ex, bias_string) for ex in data["test_withref"]],
    )
